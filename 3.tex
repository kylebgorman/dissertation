...
%In this chapter, I present evidence that speakers 
%glossematics
...
%\citet{Davidson2005,Davidson2006a} shows that this ``excrescent'' schwa is distinct both in acoustics and articulation from ``lexical schwa'': English speakers' [z${^\textrm{ə}}$k] is more similar to \emph{scum} than \emph{succumb}.
%\citet{Wilson2011} show that speakers use this 
